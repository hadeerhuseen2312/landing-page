...
let hadeerContent=" hadeer hadeer hadeer hadeer hadeer hadeer hadeer hadeerhadeerhadeer hadeer hadeer hadeer hadeer hadeer hadeer hadeerhadeer ";
let icons=["Home","About","Contact Us","Hadeer"];
...
function createUlElements(item){
    ...
    anchor.style="text-decoration:none;padding:10px;border: solid #ffccff 2px ;border-radius:50px;margin:3px;color:black";
    ...
    hr.style="border-width:2px;margin:50px auto;";
     ...
     switch(item){
         ...
         case "Hadeer":
         textnode=document.createTextNode(hadeerContent);        
         break;
     }
    //create nav menue
...
//style
nav.style="list-style-type:none;height:100px;float:right;font-size: larger";
